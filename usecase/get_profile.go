...
func (uc *usecase) getUserStandardNutrients(userData model.User) nutrients {
...
func (uc *usecase) getUserCurrentNutrients(ctx context.Context, user model.User) nutrients {
	userNutrients := nutrients{}
